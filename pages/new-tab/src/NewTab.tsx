...
const NewTab = () => {
  ...
  return (
    <div className={`App ${isLight ? '' : 'dark'}`} data-testid="app">
      <div className="min-h-screen flex flex-col items-center justify-center bg-background text-foreground text-center text-[calc(10px+2vmin)]">
        ...
        <p>
          Edit <code className="bg-muted rounded px-1.5 py-0.5 text-sm">pages/new-tab/src/NewTab.tsx</code>
        </p>
...
export default withErrorBoundary(
  withSuspense(NewTab, <div className="p-4 text-muted-foreground">{t('loading')}</div>),
